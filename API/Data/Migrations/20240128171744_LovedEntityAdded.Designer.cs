...
namespace API.Data.Migrations
{
    ...
    [Migration("20240128171744_LovedEntityAdded")]
    partial class LovedEntityAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Entities.Loved", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.LovedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Entities.LovedItem", b =>
                {
                    b.HasOne("API.Entities.Loved", "Loved")
                        .WithMany("Items")
                        .HasForeignKey("LovedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
